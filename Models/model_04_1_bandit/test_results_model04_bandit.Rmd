...
```{r}
setwd("C:/Users/haase_k/Desktop/SVNKevin/PhD-Anglerverhalten/modelling/Angler Model/NetLogo/model_04_1_bandit")
```
...
write.table(bandit_parameter, "model_output/1000runs/bandit_results.csv", sep = ",", row.names = FALSE)
```
...
```{r}
write.table(perc.diff, "model_output/1000runs/bandit_perc_diff.csv", sep = ",", row.names = FALSE)
```
