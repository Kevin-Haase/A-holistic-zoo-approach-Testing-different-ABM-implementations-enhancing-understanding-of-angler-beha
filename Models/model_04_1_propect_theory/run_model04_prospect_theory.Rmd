...
modelpath <- file.path("C:/Users/haase_k/Desktop/SVNKevin/PhD-Anglerverhalten/modelling/Angler Model/NetLogo/model_04_prospect_theory/04_GISworld_prospect_theory.nlogo")
outpath <- file.path("C:/Users/haase_k/Desktop/SVNKevin/PhD-Anglerverhalten/modelling/Angler Model/NetLogo/model_04_prospect_theory/model_output")
...
```{r}
nl@experiment <- experiment(expname="model_04_prospect_theory",
                            outpath= outpath,
                            idsetup= "setup",
                            idgo= "go",
                            ...
                            constants = list("value-of-catch_utility_b" = 1/9, 
                                            ...
                                            "value-of-parameter_PTa" = 0.42, 
                                            "value-of-parameter_PTb" = 0.49, 
                                            "value-of-parameter_PTl" = 1.38, 
                                            "value-of-parameter_up_pos" = 0.44, 
                                            "value-of-parameter_up_neg" = 0.71),
                            
                            variables = list('value-of-parameter_a' = list(values=seq(0, 1, 0.05))),
