...
```{r}
setwd("C:/Users/haase_k/Desktop/SVNKevin/PhD-Anglerverhalten/modelling/Angler Model/NetLogo/model_04_1_prospect_theory")
```
...
write.table(prospect_theory_parameter, "model_output/prospect_theory_results.csv", sep = ",", row.names = FALSE)
```
...
```{r}
write.table(perc.diff, "model_output/prospect_theory_perc_diff.csv", sep = ",", row.names = FALSE)
```
