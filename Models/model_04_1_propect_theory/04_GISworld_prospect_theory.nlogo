...
to choose-location
  ...
  set chosen_location max-one-of possible_locations [location_value]                                            ; angler chose the location of the possible locations (same fishing method) that has the maximum location value
