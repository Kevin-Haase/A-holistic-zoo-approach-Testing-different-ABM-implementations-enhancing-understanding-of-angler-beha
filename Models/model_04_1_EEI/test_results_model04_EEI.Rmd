...
```{r}
setwd("C:/Users/haase_k/Desktop/SVNKevin/PhD-Anglerverhalten/modelling/Angler Model/NetLogo/model_04_1_EEI")
```
...
write.table(EEI_parameter, "model_output/1000runs/EEI_results.csv", sep = ",", row.names = FALSE)
```
...
```{r}
write.table(perc.diff, "model_output/1000runs/EEI_perc_diff.csv", sep = ",", row.names = FALSE)
```
